...
<html lang="en">
	...
	<div class="card text-center">
  		<div class="card-header">PANGGIL NOMOR ANTRIAN</div>
  			<div class="card-body">
    	...
    	<form>
        	...
        	<button type="button" class="btn btn-primary next_getway" onClick="window.location.href=window.location.href" >Next <span class="fa fa-chevron-circle-right"></span></button>
	      	</div>
    	</form>
    	<br/>
      	<footer class="footer">
